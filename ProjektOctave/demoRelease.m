...
clear all %optional clear workspace
pkg load image

addpath ~/ %put your own path to osusvm here
...
train_set.pos   = 'Image_Datasets/train_pos';
train_set.neg   = 'Image_Datasets/train_neg';
test_set.pos    = 'Image_Datasets/test_pos';
test_set.neg    = 'Image_Datasets/test_neg';
